...
# --- Config ---
AGENT_NAME    = "Agent1"          # Display name used in schema labels
AGENT_KEYWORD = "agent1"          # Lowercase — matched against peer summaries/IDs to find this agent
PROJECT_DIR   = r"C:\path\to\your\.claude\projects\your-project-id"
SCHEMA_PATH   = r"C:\path\to\your\agent1_context_schema.md"
...
def main():
    log(f"sage_memory_condenser starting (agent: {AGENT_NAME})")
