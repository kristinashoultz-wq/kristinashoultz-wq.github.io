"""
lumen_knowledge_graph.py — Lumen's Local Knowledge Graph Engine
...
builds a live topology graph, and exposes it via:
  ...
  1. lumen_topology.json    — machine-readable graph (C:/Users/krist/)
...
QUERY PROTOCOL (newline-delimited JSON over TCP)
  ...
  {"query": "brother", "value": "Isaiah"}
  {"query": "script",  "value": "orchestrator.py"}
  {"query": "all"}

HOW TO START
  py -3.12 C:/Users/krist/lumen_knowledge_graph.py
  Ctrl+C to stop.
...
# ─────────────────────────────────────────────
BASE     = Path(r"C:\Users\krist")
REEVES   = BASE / "Documents" / "Reeves Family"
...
def _render_ecosystem_map(graph: dict) -> str:
    ...
    lines = [
        "# Ecosystem Map",
        f"*Auto-generated by Lumen's Knowledge Graph · {ts}*",
...
async def main() -> None:
    ...
    log.info(
        "Lumen Knowledge Graph online | query port: %d | scan interval: %ds",
